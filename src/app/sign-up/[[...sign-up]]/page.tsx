...
export default function SignUpPage() {
  return (
    <section className="mt-[7.5rem] flex h-screen w-screen scroll-mt-96 justify-center sm:mt-[4rem]">
      <motion.div
        ...
        <SignUp
          appearance={{
            elements: {
              ...
              card: "bg-violet-200/10 h-[37rem] border border-white/5 sm:hover:!scale-[1.025] transition",
